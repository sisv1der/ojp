...
@Container
public static OjpContainer ojpContainer = new OjpContainer(
    DockerImageName.parse("rrobetti/ojp:0.4.6-beta")
);
```
...
DockerImageName customImage = DockerImageName.parse("myregistry.com/my-ojp:1.0.0")
        .asCompatibleSubstituteFor("rrobetti/ojp:0.4.6-beta");
...
```java
OjpContainer ojpContainer = new OjpContainer("rrobetti/ojp:0.4.6-beta");
```
